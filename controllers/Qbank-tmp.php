...
//			}
			$data['posts'] = $this->Post->get_post(100,0,'school_online');
...
//                            $post_type = $post_type;
//                            $list_post = $this->Post->get_post(100,0,'school_online',$ses);
//                        }else{
//                            $post_type = "";
//                            $list_post =  $this->Post->manage_post(100,0);
//                        }
                        $post_type = 'school_online';
                            $list_post = $this->Post->get_post(100,0,'school_online');
		 $data['nop']=$nop;
		 $data['title']=$this->lang->line('add_new');
                 $data['post'] = $list_post;
		// fetching category list
//                $data['category_list']= $this->Core->show_all("category");
		$data['category_list']=$this->qbank_model->category_list();
		// fetching level list
                
                $data['level_list']= $this->Core->show_all("level_quiz");
//		$data['level_list']=$this->qbank_model->level_list();
//		 $this->load->view('header',$data);
