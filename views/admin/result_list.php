...
<tr>
 ...
 <td><?php if(isset($val['name']))echo $val['name']; else echo $user_name?> </td>
...
if($logged_in['su']=='1'){
	?>
	<a href="javascript:remove_entry('result/remove_result/<?php echo $val['rid'];?>');"><img src="<?php echo base_url('uploads/files/cross.png');?>"></a>
<?php 
}
?>
</td>
