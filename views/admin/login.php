        ...
        <div class="admin-form">
            ...
            <div class="widget worange">
                ...
                <div class="widget-head">
                    <i class="fa fa-lock"></i> Đăng Nhập Quản Trị Viên
                </div>
                <?php
//                if (!empty($validation)) {
...
//                }
                ...
                <div class="widget-content">
                    <div class="padd">
                        <!-- Login form -->
                        <form class="form-group" action="<?php echo SITE_DIR; ?>login/validation_login" method="post">
                            <!-- Email -->
