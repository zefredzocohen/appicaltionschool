...
<?php echo $this->lang->line('multiple_choice_single_answer');?>
			...
			<div class="form-group">	 
					...
					foreach($category_list as $key => $val){
						...
						<option value="<?php echo $val['cat_id'];?>"  <?php if($question['cid']==$val['cat_id']){ echo 'selected'; } ?> ><?php echo $val['category_name'];?></option>
						<?php 
					}
					?>
					</select>
			...
			<div class="form-group">	 
					...
					foreach($level_list as $key => $val){
						...
						<option value="<?php echo $val['lid'];?>" <?php if($question['lid']==$val['lid']){ echo 'selected'; } ?> ><?php echo $val['lname'];?></option>
						<?php 
					}
					?>
					</select>
