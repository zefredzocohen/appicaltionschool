 ...
 <div class="login-panel panel panel-default">
		...
		?>	
					...
					foreach($category_list as $key => $val){
						...
						<option value="<?php echo $val['cat_id'];?>"  <?php if($val['cat_id']==$quiz['cat_id']){ echo 'selected';} ?>  ><?php echo $val['category_name'];?></option>
						<?php 
					}
					?>
					</select>
...
<td>
 ...
 <a href="<?php echo site_url('quiz/remove_qid/'.$quiz['quid'].'/'.$val['qid']);?>" title="<?php echo $this->lang->line('remove_from_quiz');?>"><img src="<?php echo base_url('uploads/files/cross.png');?>"></a>
 <?php 
 if($key==0){
	 ?>
	 <img src="<?php echo base_url();?>uploads/files/empty.png" title="">
	 <?php 
 }else{
	 ?>
 <a href="javascript:cancelmove('Up','<?php echo $quiz['quid'];?>','<?php echo $val['qid'];?>','<?php echo $key+1;?>');"><img src="<?php echo base_url();?>uploads/files/up.png" title="<?php echo $this->lang->line('up');?>"></a>
<?php 
 }
...
<?php 
	...
	?>
<a href="javascript:cancelmove('Down','<?php echo $quiz['quid'];?>','<?php echo $val['qid'];?>','<?php echo $key+1;?>');"><img src="<?php echo base_url();?>uploads/files/down.png" title="<?php echo $this->lang->line('down');?>"></a>
<?php 
}
?>
</td>
	...
	foreach($qcl as $k => $vall){
		...
		?>
					...
					foreach($category_list as $key => $val){
						...
						<option value="<?php echo $val['cat_id'];?>"   <?php if($val['cat_id']==$vall['cid']){ echo 'selected'; } ?>  ><?php echo $val['category_name'];?></option>
						<?php 
					}
					?>
					</select>
				...
				<option value="0"><?php echo $this->lang->line('select');?> <?php echo $this->lang->line('level_name');?></option>
					...
					foreach($level_list as $key => $val){
						...
						<option value="<?php echo $val['lid'];?>"   <?php if($val['lid']==$vall['lid']){ echo 'selected'; } ?> ><?php echo $val['lname'];?></option>
						<?php 
					}
					?>
					</select>
