...
<br> 
		...
		?>	
					...
					foreach($category_list as $key => $val){
						...
						<option value="<?php echo $val['cat_id'];?>" <?php if($val['cat_id']==$cid){ echo 'selected';} ?> ><?php echo $val['category_name'];?></option>
						<?php 
					}
					?>
					</select>
				...
				<option value="0"><?php echo $this->lang->line('all_level');?></option>
					...
					foreach($level_list as $key => $val){
						...
						<option value="<?php echo $val['lid'];?>"  <?php if($val['lid']==$lid){ echo 'selected';} ?> ><?php echo $val['lname'];?></option>
						<?php 
					}
					?>
					</select>
...
<td><?php echo $val['category_name'];?> / <span style="font-size:12px;"><?php echo $val['lname'];?></span></td>
...
?>
<a href="<?php echo site_url('qbank/edit_question_'.$qn.'/'.$val['qid']);?>"><img src="<?php echo base_url('uploads/files/edit.png');?>"></a>
<a href="javascript:remove_entry('qbank/remove_question/<?php echo $val['qid'];?>');"><img src="<?php echo base_url('uploads/files/cross.png');?>"></a>
